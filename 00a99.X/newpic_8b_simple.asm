...
LACO_PRINCIPAL_DEC
    ...
    CALL    TROCA_LED	    ;se FIM_LED = 1, chama a rotina de troca de estado do LED 
    BTFSS   FIM_TEMPO	    ;testa se o FIM_TEMPO = 1
    GOTO    LACO_PRINCIPAL_DEC  ;se FIM_TEMPO = 0, pula para  LACO_PRINCIPAL
    BCF	    FIM_TEMPO	    ;FIM_TEMPO = 0
    DECF    UNIDADE,F	    ;UNIDADE--
    MOVLW   .10		    ;W = 10 (B'00001010' ou 0x0A)
    SUBWF   UNIDADE,W	    ;W = UNIDADE - W
    BTFSS   STATUS,C	    ;testa se o resultado é positivo
    GOTO    LACO_PRINCIPAL_DEC  ;se resutado for negativo, pula para LACO_PRINCIPAL
    CALL    _9U
    ...
    BTFSC   STATUS,C	    ;testa se o resultado é negativo
    CALL    _9D
    GOTO    LACO_PRINCIPAL_DEC  ;pula para LACO_PRINCIPAL 
...
PARADO
    ...
    BTFSS   B_ZERAR	    ;testa se o botão B_ZERAR está liberado
    GOTO    RESETA  ;se não pressionado pule para LACO_PRINCIPAL
    BTFSS   B_DEC
    GOTO    B_DEC_PRESS  ;pula para LACO_PRINCIPAL
    GOTO    LACO_PRINCIPAL
