...
TROCA_DISPLAY
    ...
    BTFSC   D_UNIDADE	    ;testa se o display da UNIDADE está acesso
    GOTO    ACENDE_UNIDADE    ;se UNIDADE não estiver acesa, pula para TESTA_DEZENA
    BTFSC   D_DEZENA
    GOTO    ACENDE_DEZENA
    BTFSC   D_CENTENA
    GOTO    ACENDE_CENTENA
...
ACENDE_UNIDADE
    ...
    CALL    BUSCA_CODIGO2    ;chama a subrotina para buscar o código de 7 segmentos
    MOVWF   DISPLAYS	    ;DISPLAYS = W (código de 7 segmentos)
